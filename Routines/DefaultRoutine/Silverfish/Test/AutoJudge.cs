...
namespace HREngine.Bots
{
    ...
    {
        private static string mainPath = @"D:\Hearthbuddy_backed\Routines\DefaultRoutine\Silverfish\"; // 确保此路径正确
        private static string testPath = @"Test\Data\test\17-14-59-PALADIN-HUNTER"; // 需要测试的文件夹 
